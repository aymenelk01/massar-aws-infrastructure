# Create a CloudWatch log group for lambda function logs, with a retention period of 365 days. This log group will store the logs generated by the Lambda functions used in the notifications system.
